import { Image, ImageProps, ImageStyle, StyleProp, TextStyle, ViewStyle } from "react-native"
...
export function EmptyState(props: EmptyStateProps) {
  ...
  return (
    <Box style={$containerStyleOverride}>
      {isImagePresent && (
        <Image
          source={imageSource}
          {...ImageProps}
      ...
      {isImagePresent && (isHeadingPresent || isContentPresent || isButtonPresent) && (
        <Box marginBottom="xs" />
      )}

      {isHeadingPresent && (
        <Box
          marginTop={isImagePresent ? "xs" : undefined}
          marginBottom={isContentPresent || isButtonPresent ? "xs" : undefined}
          paddingHorizontal="l"
        >
          <Text
            variant="subheading"
      ...
      {isContentPresent && (
        <Box
          marginTop={isImagePresent || isHeadingPresent ? "xs" : undefined}
          marginBottom={isButtonPresent ? "xs" : undefined}
          paddingHorizontal="l"
        >
          <Text
            variant="body"
      ...
      {isButtonPresent && (
        <Button
          ...
          style={[
            isImagePresent || isHeadingPresent || isContentPresent ? { marginTop: spacing.xl } : undefined,
            $buttonStyleOverride,
            ButtonProps?.style,
          ]}
          {...ButtonProps}
